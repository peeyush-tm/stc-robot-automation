...
TC_SRM_004 Verify Assets Type Is Hidden For MSISDN Flow
    ...
    [Tags]    regression    positive    sim_range    msisdn
    TC_SRM_004
...
TC_SRM_009 Verify Cancel Button Redirects To SIM Range List
    ...
    [Tags]    regression    positive    sim_range    msisdn    navigation
    TC_SRM_009
...
TC_SRM_015 MSISDN From Greater Than To Should Show Error
    ...
    [Tags]    regression    negative    sim_range    msisdn    boundary
    TC_SRM_015
...
TC_SRM_021 SQL Injection In Pool Name Should Be Rejected
    ...
    [Tags]    regression    negative    security    sim_range    msisdn
    TC_SRM_021
...
TC_SRM_025 Direct Access To Create MSISDN SIM Range Without Login
    ...
    [Tags]    regression    negative    security    sim_range    msisdn    navigation
    TC_SRM_025
