...
TC_PT_001 Create SIM Product Type Standard Flow
    ...
    [Tags]    smoke    regression    positive    product-type    TC_PT_001
    TC_PT_001
...
TC_PT_002 Assign EC To Existing Product Type
    ...
    [Tags]    smoke    regression    positive    product-type    TC_PT_002
    TC_PT_002
...
TC_PT_011 Verify Create Button Visible For RW User
    ...
    [Tags]    regression    positive    product-type    TC_PT_011
    TC_PT_011

TC_PT_013 Close Assign Popup Without Saving Should Not Change Assignment
    ...
    [Tags]    regression    positive    TC_PT_013
    TC_PT_013
...
TC_PT_003 Submit Without Selecting Account
    ...
    [Tags]    regression    negative    product-type    TC_PT_003
    TC_PT_003
...
TC_PT_004 Submit With Blank Product Type Name
    ...
    [Tags]    regression    negative    product-type    TC_PT_004
    TC_PT_004
...
TC_PT_005 Submit Without Selecting Service Type
    ...
    [Tags]    regression    negative    product-type    TC_PT_005
    TC_PT_005
...
TC_PT_006 Submit With Blank Service Sub Type 2
    ...
    ...                Verify: validation error, form does not submit.
    [Tags]    regression    negative    product-type    TC_PT_006
    TC_PT_006
...
TC_PT_007 Submit With Blank Service Sub Type 3
    ...
    ...                Verify: validation error, form does not submit.
    [Tags]    regression    negative    product-type    TC_PT_007
    TC_PT_007
...
TC_PT_008 Submit With Blank Service Sub Type 4
    ...
    ...                Verify: validation error, form does not submit.
    [Tags]    regression    negative    product-type    TC_PT_008
    TC_PT_008
...
TC_PT_009 Submit With Esim Sub Type 3 But Blank Profile Name
    ...
    [Tags]    regression    negative    product-type    TC_PT_009
    TC_PT_009
...
TC_PT_010 Close Create Form Without Submitting
    ...
    [Tags]    regression    negative    product-type    TC_PT_010
    TC_PT_010
...
TC_PT_012 Click Update Without Selecting Any EC
    ...
    [Tags]    regression    negative    product-type    TC_PT_012
    TC_PT_012

TC_PT_017 Duplicate Product Type Name Should Show Error Toast
    ...
    [Tags]    regression    negative    TC_PT_017
    TC_PT_017
...
TC_PT_014 Edit Icon Should Be Visible In Product Type Grid
    ...
    [Tags]    regression    TC_PT_014
    TC_PT_014

TC_PT_015 Assign Customer Icon Should Be Visible In Grid For RW User
    ...
    [Tags]    regression    TC_PT_015
    TC_PT_015

TC_PT_016 Search Product Type In Listing Grid
