...
TC_SM_002 Capture SIM Row Count And Ensure EC IMSI Capacity
...
TC_SM_005 Perform State-Aware SIM Movement To Target BU
    ...
    [Tags]    smoke    regression    positive    manage-devices    sim-movement
    TC_SM_005

# ═══════════════════════════════════════════════════════════════════════
#  POSITIVE — BATCH JOB LOG (Request Id from TC_SM_005)
# ═══════════════════════════════════════════════════════════════════════
...
TC_SM_012 SIM Movement Without Selecting Any SIM Should Not Allow Action
    ...
    [Tags]    regression    negative    sim-movement
    TC_SM_012

TC_SM_013 Close SIM Movement Modal Without Proceeding Should Not Move SIM
