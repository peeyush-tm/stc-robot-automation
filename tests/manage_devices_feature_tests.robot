...
TC_MD_001 Verify Manage Devices Page Loads And Displays Device List With All Expected Columns
    ...
    [Tags]    feature    regression    manage-devices
...
TC_MD_002 Verify SIM STATE Column Displays Correct Colour-Coded States
...
TC_MD_003 Verify Pagination Controls Navigate Correctly Between Pages
...
TC_MD_004 Verify Column Sort Ascending And Descending On Key Columns
...
TC_MD_005 Verify Expand Row Button Shows Device Sub-Details
...
TC_MD_006 Verify Top-Right Lock Or Export Icon Is Functional
    [Documentation]    PRE: Manage Devices loaded.
...
TC_MD_007 Verify Search By ICCID Returns Correct Device
...
TC_MD_008 Verify Search Filter Dropdown Can Be Changed
...
TC_MD_009 Verify Change State Filter Dropdown Filters List By SIM State
    [Documentation]    PRE: Manage Devices loaded.
...
TC_MD_010 Verify Search With Invalid Or Non-Existent ICCID Shows No Results
    ...
    [Tags]    feature    regression    manage-devices    negative
    Set Search Filter Dropdown To    ICCID
...
TC_MD_011 Verify Search Field With Special Characters Or SQL Injection Is Handled Safely
    [Documentation]    PRE: Manage Devices loaded.
    ...
    [Tags]    feature    regression    manage-devices    security    negative
...
TC_MD_012 Verify Individual Device Row Selection Via Checkbox
...
TC_MD_013 Verify Select All Checkbox In Header Selects And Deselects All Rows
...
TC_MD_014 Verify Select Dropdown Provides Selection Options
...
TC_MD_015 Verify Close Button In Selection Toolbar Clears Selection
...
TC_MD_016 Verify Change State Toolbar Contains Correct Controls
...
TC_MD_017 Verify Selecting A State And Clicking Submit Opens Change State Popup
...
TC_MD_018 Verify Clicking Submit Without Selecting Any Device Shows Validation
...
TC_MD_019 Verify Change State Close Button Dismisses Toolbar Action Without Changes
    [Documentation]    PRE: Manage Devices loaded.
...
TC_MD_020 Verify Bulk State Change Can Be Applied To Multiple Selected Devices
...
TC_MD_021 Verify Change State Popup Displays Correct Fields
...
TC_MD_022 Verify Device Plan Dropdown Lists Available Plans And Is Pre-Filled
    [Documentation]    PRE: Change State popup open.
    ...
    [Tags]    feature    regression    manage-devices    device-plan
    Open Change State Popup From Manage Devices
    Verify Device Plan Is Pre Filled    DP2_8ERCDT
...
TC_MD_023 Verify Reason Dropdown Contains All Valid Reasons And Default Is Pre-Selected
    [Documentation]    PRE: Change State popup open.
...
TC_MD_024 Verify Clicking Proceed Successfully Changes The Device State
    ...
    [Tags]    feature    regression    manage-devices    positive
    Open Change State Popup From Manage Devices
    Verify Device Plan Is Pre Filled    DP2_8ERCDT
    Verify Reason Dropdown Pre Selected    Activation by Opco
    Click Proceed In Change State Popup
...
TC_MD_025 Verify Clicking Close On Popup Cancels The State Change
    [Documentation]    PRE: Change State popup open.
...
TC_MD_026 Verify Clicking X Icon On Popup Header Cancels Without Changes
    [Documentation]    PRE: Change State popup open.
...
TC_MD_027 Verify Proceed Button Without Selecting Reason Shows Validation
    [Documentation]    PRE: Change State popup open.
...
TC_MD_028 Verify Proceed Button Without Selecting Device Plan Shows Validation
    [Documentation]    PRE: Change State popup open.
...
TC_MD_029 Verify State Transition From InActive To Activated
...
TC_MD_030 Verify State Transition From Activated To Suspended
...
TC_MD_031 Verify State Transition From Warm To Activated
...
TC_MD_032 Verify System Prevents Or Warns When Setting Device To Its Current State
...
TC_MD_033 Verify Case ID Dropdown Lists Available Cases And Can Be Selected
...
TC_MD_034 Verify Submit Button In Left Toolbar With Case ID Submits Action
...
TC_MD_035 Verify Submit Left Toolbar Without Case ID Shows Validation
...
TC_MD_036 Verify All Tabs In Devices Module Are Accessible And Load Correctly
    ...
    [Tags]    feature    regression    manage-devices    navigation
...
TC_MD_037 Verify Returning To Manage Devices Tab Retains Or Resets List State
...
TC_MD_038 Verify Page Performance With Large Data Set (2831 Devices / 142 Pages)
...
TC_MD_039 Verify Browser Refresh Does Not Crash The Page Or Lose Critical Context
    [Documentation]    PRE: Manage Devices loaded.
...
TC_MD_040 Verify Error Handling When Change State API Fails
...
TC_MD_041 Verify Unauthorized User Cannot Perform State Change
...
TC_MD_042 Verify UI Layout Is Responsive And Columns Remain Readable
    [Documentation]    PRE: Manage Devices loaded.
...
TC_MD_043 Verify Blue Pencil Icon On Device Row Opens Device Detail Or Note Editor
